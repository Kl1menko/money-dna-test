...
Повноцінний SPA-проєкт на чистому HTML/CSS/JS із бекендом на Node.js + Express і файловою БД SQLite. Дозволяє пройти 56 тверджень, побачити топ-3 архетипи та зберегти результат.
